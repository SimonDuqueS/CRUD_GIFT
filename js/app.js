// Intentar cargar datos desde el Local Storage
let datos = localStorage.getItem('datos');

// Verificar si hay datos en el Local Storage
if (datos) {
  // Si hay datos, conviértelos a un objeto JavaScript
  datos = JSON.parse(datos);
} else {
  // Si no hay datos en el Local Storage, utiliza los datos del archivo JSON
  datos = require("../data/data.json");
}
